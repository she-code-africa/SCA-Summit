...
const CalendarIcon = ({ className }: Props) => {
  return (
    <svg
      ...
      className={className}
    >
      <g clipPath="url(#clip0_912_8854)">
        <path
          d="M14.5 16H1.5C0.67 16 0 15.33 0 14.5V2.5C0 1.67 0.67 1 1.5 1H14.5C15.33 1 16 1.67 16 2.5V14.5C16 15.33 15.33 16 14.5 16ZM1.5 2C1.22 2 1 2.22 1 2.5V14.5C1 14.78 1.22 15 1.5 15H14.5C14.78 15 15 14.78 15 14.5V2.5C15 2.22 14.78 2 14.5 2H1.5Z"
          fill="#B70569"
        />
        <path
