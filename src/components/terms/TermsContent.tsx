...
//   if (block.type === "h") {
//     return (
//       <h4 className="text-lg sm:text-2xl font-semibold font-sans">{block.text}</h4>
//     );
//   }
...
const Block = ({ block }: { block: TermsBlock }) => {
  if (block.type === "p") {
    return (
      <p
        className="text-lg sm:text-2xl font-medium font-sans"
  ...
  if (block.type === "h") {
    return (
      <h4
        className="text-lg sm:text-2xl font-semibold font-sans"
        style={{ color: block.color }}
      >
        {block.text}
      </h4>
