...
export const SolidAnchor = ({ text, link }) => {
  return (
    <a
      className="bg-primary-pink rounded-30px text-white py-3.5 px-8 hover:bg-primary-light-pink hover:text-primary-pink border border-primary-pink transition ease-in delay-75 duration-300"
      href={link}
    >
      {text}
    </a>
