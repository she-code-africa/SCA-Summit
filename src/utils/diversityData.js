export const codeOfConduct = [
  {
    ...
    listTexts: [
      "Avoid offensive language, derogatory comments, or personal attacks.",
      "Engage in respectful dialogue.",
      "Do not boo a speaker, interrupt her, or use unkind words when she is speaking.",
    ],
  },

  {
    ...
    listTexts: [
      ...
      "Avoid raising your voice or engaging in heated arguments.",
      "Do not engage in physical fights.",
      "Reach out to the She Code Africa community manager to mediate the situation if necessary.",
    ],
  },
  {
    heading: "Respect for Property: ",
    listTexts: [
      "Stealing is strictly prohibited and will result in immediate disciplinary action.",
      "All equipment, facilities, and personal belongings should be treated with respect",
      "If you notice any unattended property, please alert a volunteer or staff member immediately.",
    ],
  },
];
...
export const infoCardData = [
  ...
  },
  {
    ...
    paragraph:
      "We understand the needs of mothers, and we're committed to making the summit accessible for all. This year, we'll provide a dedicated nursing and childcare room for your comfort and convenience. ",
  },
  {
    heading: "Communication Preferences",
    paragraph:
      "To ensure a positive and respectful atmosphere, please be mindful of others' communication preferences. When approaching someone for a conversation, always ask politely if they're open to chatting.",
  },
];
...
export const accessibilityData = [
  ...
  },
  {
    ...
    paragraph:
      "We understand that everyone has different comfort levels regarding photography and videography. If you prefer not to be captured on camera during the summit, please inform any media team member. If you'd like to have a private conversation, feel free to approach any organizing team member on-site. We're here to assist you and ensure your comfort throughout the event.",
  },
];
