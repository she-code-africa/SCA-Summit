  ...
  return (
    <section className="about-container">
      ...
      <div className="about-content">
        <blockquote>
          The SCA Summit 2022 is the maiden edition of what we intend to make
          our headline conference. Our goal is to gather our members from
          different states in Nigeria and neighbouring African countries for a
          hybrid summit themed "Elevating the African Woman in Tech". We plan to
          host 1,000 women participants for the first edition.
          <br />
          <br />
